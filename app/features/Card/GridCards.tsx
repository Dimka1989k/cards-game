      ...
      {hiddenCards.map((front, i) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="absolute inset-0  rounded-[1.25rem] [backface-visibility:hidden] w-full h-50 min-[480px]:max-[591px]:h-30 max-[670px]:h-45 max-[480px]:h-25">
                <Image
                  src={backside}
                  alt="backCards"
                  fill
              ...
              <div className="absolute inset-0  rounded-[1.25rem] [backface-visibility:hidden] [transform:rotateY(180deg)] w-full h-50 min-[480px]:max-[591px]:h-30 max-[670px]:h-45 max-[480px]:h-25">
                <Image
                  src={front}
                  alt="frontCards"
                  fill
